...
const index = require('@mono-pack/utils/src/index');
...
function useResponsiveRem(width) {
  ...
  const debouncedSetRem = index.debounce(setRem, 200);
  function bindEvents() {
  ...
  debouncedSetRem();
  return {
    remScale: vue.shallowReadonly(remScale),
    destroyResponsiveRem
  };
}

exports.requireAll = requireAll;
exports.useResponsiveRem = useResponsiveRem;
